...
## Api Usage:
Get Placeholder from spigot server. Example: (Bungee only) (This is from the [FernAPI](https://github.com/Fernthedev/FernAPI), it is highly suggested to use it from there instead of here)
```java
